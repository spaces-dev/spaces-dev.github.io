...
(function() {
    function spacesPlus() {
        ...
        var _SETSTRINGS = {
            ...
            'myEvents': "Звук уведомлений <span onclick='if(confirm(\"В настройках сайта должен быть ВЫКЛЮЧЕН звук уведомлений. Файл должен быть в форматах *.ogg, *.mp3 или *.wav\\nУказывайте прямую ссылку на аудиофайл!\\n\\nХотите открыть каталог звуков?\")) {window.open(\"https://" + gitPages + "\", \"_blank\");} return false;' style=\"cursor: help; float: right;\" class=\"ico ico_question_light\"></span>",
        ...
        var main = {
                            ...
                            var settLink = main.ce("a", {
                                ...
                                onclick: function(e) {
                                    ...
                                    if (prnt.id == "main") {
                                        ...
                                        prnt.innerHTML = '<div class="widgets-group widgets-group_top js-container__block"><div class="b-title cl b-title_center b-title_first oh"><div class="b-title__item">Настройки Spaces+ <sup>' + rVer + '</sup> <sup><small>build ' + main.rever(BUILD) + '</small></sup><span class="js-cnt cnt cnt_title hide"></span></div></div><div class="content"><div class="list f-c_fll"> <div id="SP_PLUS_SETAREA"></div></div></div></div> <a id="SP_PLUS_SETBACK" href="http://' + _DOMAIN + '/settings/?" class="link-return full_link"><span class="ico ico_arrow-back" style="margin: 0px 6px -1px 0px;"></span><span class="m">Назад</span></a>';
                                        ...
                                        main.alertm('<h4>Настройки <span>Spaces+ <sup>' + rVer + '</sup></span></h4><div style="line-height:1.5;display:block;height:100%;color:#ec1212;">Меню настроек больше не поддерживается на Mobile и Lite версии сайта!<br> Используйте <a href="' + _PROTOCOL + '//' + _DOMAIN + '/services/force_device_type/?Vck=' + CK + '&dtype=touch">Touch</a> или <a href="' + _PROTOCOL + '//' + _DOMAIN + '/services/force_device_type/?Vck=' + CK + '&dtype=desktop">PC</a> версию!</div>', 1, 1);
                                    }
                                    ...
                                    if (setArea) {
                                        ...
                                        if (!/(\?|&)sp_plus_settings=1/i.test(lct)) {
                                            main.historyPush({
                                                'sp_plus_settings': urlSett
                                            }, _PROTOCOL + "//" + _DOMAIN + "/settings/?sp_plus_settings=1", "Настройки Spaces+");
                                        }
                                    }
                                    return false;
                                }
                    ...
                    if (!("Notification" in window)) {
                        ...
                        Notification.requestPermission(function(permission) {
                            if (permission.toLowerCase() === "granted") {
                                ...
                                main.alertm("Вы <b style='color: #800;'>запретили</b> показывать уведомления для сайта " + _DOMAIN + "!<br/>Зайдите в настройки браузера и настройте доступ.", 1, null);
                            }
                        });
                    } else {
                        main.alertm("Разрешите браузеру показывать уведомления с сайта " + _DOMAIN + ", чтобы пользоваться функцией!", 1, null);
                    }
                } catch (e) {
                ...
                try {
                    if (!main.qs("#SP_WRAP_IMAGE")) {
                        ...
                        var style = main.ce("link", {
                            ...
                            href: "https://beta.spac.me/css/custom/Files/Tile.css"
                        })
                        document.getElementsByTagName('head')[0].appendChild(style)
                        var SPB = main.qs("#SP_PLUS_BODYSTYLE");
                    ...
                    var notifEvent = main.ce("input", {
                        ...
                        onclick: function(e) {
                            if (!("Notification" in window)) {
                                ...
                                main.alertm("Вы <b style='color: #800;'>запретили</b> показывать уведомления для сайта " + _DOMAIN + "!<br/>Зайдите в настройки браузера и настройте доступ (для Google Chrome включите HTTPS-протокол).", 1, null);
                                return false;
                            }
                        }
                    });
                                            ...
                                            main.jajax(_PROTOCOL + '//' + _DOMAIN + '/friends/?P=2&S=3', function(res2) {
                                                ...
                                                for (var i = 0; i < lenList; i++) {
                                                    frOnDiv.appendChild(main.ce("a", {
                                                        href: _PROTOCOL + "//" + _DOMAIN + "/mysite/?name=" + friendsList[i].name,
                                                        class: "li",
            ...
            bannedTools: function() {
                ...
                if (path == '/mysite/' && banLock != locationHref) {
                    try {
                        ...
                        if (nick) {
                            main.jajax(_PROTOCOL + "//" + _DOMAIN + "/mysite/?name=" + nick, function(res) {
                                try {
                                    if (res) {
            ...
            alertm: function(html, close, timer) {
                ...
                if (alDiv) {
                    alDiv.innerHTML = (close ? '<img src="' + _PROTOCOL + '//spac.me/i/remove.png" alt="" class="pointer right notif_close" onclick="document.body.removeChild(this.parentNode);" title="Закрыть" />' : '') + html;
                } else {
                    alDiv = main.ce("div", {
                        class: "sp_plus_alert_y",
                        id: "SP_PLUS_ALERT",
                        html: (close ? '<img src="' + _PROTOCOL + '//spac.me/i/remove.png" alt="" class="pointer right notif_close" onclick="document.body.removeChild(this.parentNode);" title="Закрыть" />' : '') + html
                    });
                    document.body.appendChild(alDiv);
                }
                if (!timer) {
            ...
            adsRemove: function() {
                var adsblock = main.find(document.links, {
                    href: _PROTOCOL + "//" + _DOMAIN + "/?iF5oox6g="
                });
                if (adsblock) {
                    main.remove(adsblock[0].parentNode);
                }
                var adsblock = main.find(document.images, {
                    src: "/static/i/close3.png"
                });
                if (adsblock) {
                    main.remove(adsblock[0].parentNode.parentNode);
                }
                var appblock = main.find(document.links, {
                    href: _PROTOCOL + "//" + _DOMAIN + "/app/add/?add="
                })
                if (appblock) {
                    if (appblock[0].parentNode.className == 'widgets-group widgets-group_top') {
                        main.remove(appblock[0].parentNode.parentNode);
                    }
                }
            ...
            setStyle: function() {
                ...
                if (_SETTINGS.msgAlert) {
                    if (_SETTINGS.msgAlertSettings.animDelay && _SETTINGS.msgAlertSettings.alertPosition) {
                        ...
                        stl.innerHTML += '.mailBox{border-radius:2px; border:1px solid #cdd4e1; background:#fff; box-shadow:0 0 10px rgba(0,0,0,0.5); text-decoration:none !important; display:block; width:280px; height:auto; ' + mailBox + ' -webkit-animation: create 2s; animation: create ' + _SETTINGS.msgAlertSettings.animDelay + 's} .mailContainer {z-index: 99999; position: fixed; ' + mailContainer + ' padding: 10px} .mailBox .data {display: inline-block; position: absolute; padding-top: 5px;} .mailBox .avatar {width: 64px; padding-right: 5px; border-radius:2px;} .text>img {display: inline-block;}.text>div.image_limit {width: 28px; display: inline-block;} .mailBox .name {line-height: 20px; font-weight: bold;} .mailBox .text {white-space: nowrap; text-overflow: ellipsis; overflow: hidden; color: #323232; width: 195px;} @-webkit-keyframes create {0% {opacity: 0;} 100% {opacity: 1;}} @-webkit-keyframes destroy {0% {opacity: 1;} 100% {opacity: 0;}}}'
                    }
                ...
                main.ajax("https://" + gitPages + "/updater.json", "GET", null, function(r) {
                    if (r) {
                        ...
                        if (json.latest.build > BUILD) {
                            main.alertm('<div>Доступна новая версия <b>Spaces+ <sup>2.0</sup></b></div><br/><div>Что нового в сборке ' + main.rever(json.latest.build) + ':<br /><small>' + json.latest.changes + '</small></div></div><br/><a href="http://' + gitPages + '/spaces_plus.user.js" onclick="document.body.removeChild(this.parentNode); return true;" class="sp_plus_a" style="color: #1cc61c;">Обновить</a>&nbsp;&nbsp;', 1, 1);
                ...
                if (data.act == 1) {
                    ...
                    main.ajax(_PROTOCOL + '//' + _DOMAIN + '/neoapi/mail', 'POST', params, function(res) {
                        ...
                        if (data.data.contact.user != undefined) {
                            ...
                            avatar = "https://raw.githubusercontent.com/" + gitPages + "/master/src/spaces/talk.jpg"
            ...
            freeSticker: function(checked) {
                ...
                if (script) {
                    ...
                    var e = main.ce("script", {
                        type: "text/javascript",
                        id: "SP_PLUS_STICKER",
                        html: "var send=XMLHttpRequest.prototype.send;XMLHttpRequest.prototype.send=function(e){return(-1!=String(e).indexOf('method=sendMessage')||-1!=String(e).indexOf('method=add')&&-1!=String(e).indexOf('comment'))&&this.setRequestHeader('x-proxy','spaces'),send.apply(this,arguments)};"
                    })
