                ...
                try {
                    if (urls) {
                        for (var i = 0; i < urls.length; i++) {
                            urls[i].setAttribute("href", urls[i].innerText);
                        }
                    }
                } catch (e) {
